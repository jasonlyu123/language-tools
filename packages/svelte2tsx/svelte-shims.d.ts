...
declare function __sveltets_2_ensureComponent<T extends new (args: {target: any, props?: any}) => Svelte2TsxComponent<any, unknown, any>>(type: T): T extends never ? Svelte2TsxComponent<any, any, any> : T;
