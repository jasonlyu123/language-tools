...
function render/*Ωignore_startΩ*/<A,B extends keyof A,C extends boolean>/*Ωignore_endΩ*/() {
     ...
     let a: A/*Ωignore_startΩ*/;a = __sveltets_1_any({});/*Ωignore_endΩ*/;
     let b: B/*Ωignore_startΩ*/;b = __sveltets_1_any({});/*Ωignore_endΩ*/;
     let c: C/*Ωignore_startΩ*/;c = __sveltets_1_any({});/*Ωignore_endΩ*/;
