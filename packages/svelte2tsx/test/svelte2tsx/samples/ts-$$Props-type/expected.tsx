...
<></>;function render() {
    ...
    interface $$Props {
     ...
     let exported1: string/*Ωignore_startΩ*/;exported1 = __sveltets_1_any({});/*Ωignore_endΩ*/;
     let exported2: string = ''/*Ωignore_startΩ*/;exported2 = __sveltets_1_any({});/*Ωignore_endΩ*/;

    let name1: string = "world"/*Ωignore_startΩ*/;name1 = __sveltets_1_any({});/*Ωignore_endΩ*/
    let name2: string/*Ωignore_startΩ*/;name2 = __sveltets_1_any({});/*Ωignore_endΩ*/;

    let rename1: string = ''/*Ωignore_startΩ*/;rename1 = __sveltets_1_any({});/*Ωignore_endΩ*/;
    let rename2: string/*Ωignore_startΩ*/;rename2 = __sveltets_1_any({});/*Ωignore_endΩ*/;
