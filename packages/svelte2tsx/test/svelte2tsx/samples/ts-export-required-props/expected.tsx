...
<></>;function render() {
     ...
     let a: number/*Ωignore_startΩ*/;a = __sveltets_1_any({});/*Ωignore_endΩ*/;
     let b: number | undefined/*Ωignore_startΩ*/;b = __sveltets_1_any({});/*Ωignore_endΩ*/;
     let c: number = 123/*Ωignore_startΩ*/;c = __sveltets_1_any({});/*Ωignore_endΩ*/;
;
() => (<></>);
